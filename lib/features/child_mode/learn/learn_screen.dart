...
class _LearnScreenState extends ConsumerState<LearnScreen> 
  ...
  final List<Activity> _activities = [
    Activity(
      ...
      description: 'Fun math problems for kids',
      ...
      duration: 15,
      xpReward: 50,
      thumbnailUrl: 'assets/images/math.png',
      tags: ['math', 'numbers', 'addition'],
      learningObjectives: ['Learn addition', 'Practice counting'],
    ...
    Activity(
      ...
      duration: 20,
      xpReward: 60,
      thumbnailUrl: 'assets/images/science.png',
      tags: ['science', 'nature', 'experiments'],
      learningObjectives: ['Understand basic science', 'Learn about nature'],
      isOfflineAvailable: true,
      isPremium: false,
      parentApprovalRequired: false,
      createdAt: DateTime.now(),
    ...
    Activity(
      id: '3',
      title: 'Reading Time',
      description: 'Interactive stories for kids',
      ...
      duration: 10,
      xpReward: 40,
      thumbnailUrl: 'assets/images/reading.png',
      tags: ['reading', 'stories', 'vocabulary'],
      learningObjectives: ['Improve reading', 'Learn new words'],
      isOfflineAvailable: true,
      isPremium: false,
      parentApprovalRequired: false,
      createdAt: DateTime.now(),
    ...
    Activity(
      ...
      description: 'Learn about emotions and friendship',
      ...
      duration: 12,
      xpReward: 45,
      thumbnailUrl: 'assets/images/social.png',
      tags: ['emotions', 'friendship', 'social'],
      learningObjectives: ['Understand emotions', 'Learn social skills'],
      isOfflineAvailable: true,
      isPremium: false,
      parentApprovalRequired: false,
      createdAt: DateTime.now(),
    ...
    Activity(
      ...
      category: ActivityCategories.creativity,
      ...
      duration: 25,
      xpReward: 55,
      thumbnailUrl: 'assets/images/art.png',
      tags: ['art', 'creativity', 'crafts'],
      learningObjectives: ['Develop creativity', 'Improve fine motor skills'],
      isOfflineAvailable: true,
      isPremium: false,
      parentApprovalRequired: false,
      createdAt: DateTime.now(),
    ...
    Activity(
      id: '6',
      title: 'Music Fun',
      description: 'Learn about music and rhythm',
      ...
      duration: 8,
      xpReward: 35,
      thumbnailUrl: 'assets/images/music.png',
      tags: ['music', 'rhythm', 'songs'],
      learningObjectives: ['Learn rhythm', 'Enjoy music'],
      isOfflineAvailable: true,
      isPremium: false,
      parentApprovalRequired: false,
      createdAt: DateTime.now(),
  ...
  Widget build(BuildContext context) {
    final filteredActivities = _activities.where(
